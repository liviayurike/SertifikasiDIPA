...
public class CashflowRecyclerAdapter extends RecyclerView.Adapter<org.android.mycashbook.CashflowRecyclerAdapter.CashflowViewHolder> {
    private List<org.android.mycashbook.Cashflow> listCashflow;

    public CashflowRecyclerAdapter(List<org.android.mycashbook.Cashflow> listCashflow) {
    ...
    public int getItemCount() {
        Log.v(org.android.mycashbook.CashflowRecyclerAdapter.class.getSimpleName(),""+listCashflow.size());
