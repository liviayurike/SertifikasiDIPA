...
public class IncomeActivity extends AppCompatActivity {
    ...
    private org.android.mycashbook.Cashflow cashflow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cashflow = new org.android.mycashbook.Cashflow();
        ...
        kalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(org.android.mycashbook.IncomeActivity.this, date, myCalendar
